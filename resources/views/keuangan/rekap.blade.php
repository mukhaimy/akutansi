                                        ...
                                        <div class="row">
                                            <div class="col mb-3">
                                                ...
                                                <select class="form-control" name="lokasiId" id="lokasi" aria-describedby="lokasiItem" required>
                                                    <option class="bg-success text-white" style="display: none" selected="true" value="{{$lokasiId}}">{{$lokasiNama}}</option>
                                                    @foreach ($perlokasies as $valueLokasi)
                                            ...
                                            <div class="col mb-3">
                                                ...
                                                <select class="form-control" name="bulanId" id="bulan" aria-describedby="bulanItem" required>
                                                    <option class="bg-success text-white" style="display: none" selected="true" value="{{$bulanId}}">{{$bulanNama}}</option>
                            ...
                            <div class="position-relative mb-4">
                                <table id="tbl_exporttable_to_xls" class="table-responsive table table-striped">
                                    <thead>
                                        <tr>
                                            <th scope="col">No</th>
                                            <th style="display: none;" scope="col">Lokasi</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="display: none;">{{$lokasiNama}}</td>
...
<script>
    function ExportToExcel(type, fn, dl) {
        ...
        return dl ?
            ...
            XLSX.writeFile(wb, fn || ('rekap {{$lokasiNama}} {{$bulanNama}} {{$tahunNama}}.' + (type || 'xlsx')));
    }
</script>
