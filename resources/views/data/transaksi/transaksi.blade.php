                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="d-flex justify-content-between align-self-center">
                                ...
                                <div class="p-2">
                                    <form method="POST" action="/transaksi-import" enctype="multipart/form-data">
                                        @csrf
                                ...
                                <div class="p-2">
                                    ...
                                    @if (auth()->user()->role=="admin")
                                    <form method="GET" action="/transaksi-tambah">
                            ...
                            <div class="position-relative mb-4">
                                <table id="tbl_exporttable_to_xls" class="table-responsive table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <hr>
                                        <tr>
                                            @foreach($transaksies as $value)
                                            <div class="ms-5 me-5">
                                                <form method="GET" action="/transaksi-update/{{$value->id}}">
                                                    @csrf
                                                    <div class="mb-3">
                                                        <h4>Editing</h4>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="transaksi" name="transaksi" aria-describedby="transaksiItem" value="{{$value->nama}}" required>
                                        ...
                                        <hr>
                                        <br>
                                        @foreach ($pertransaksies as $value)
                                        <tr>
                                            ...
                                            @if (auth()->user()->role=="admin")
                                            <td>
                                                <form method="GET" action="/transaksi-edit/{{$value->id}}">
                                                    @csrf
                                                    <button type="submit" class="btn btn-success text-light">Edit</button>
                                                </form>
                                            </td>
                                            <td>
                                                <form method="GET" action="/transaksi-hapus/{{$value->id}}">
                                                    @csrf
