                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="d-flex justify-content-between align-self-center">
                                ...
                                <div class="p-2">
                                    <form method="POST" action="/barang-import" enctype="multipart/form-data">
                                        @csrf
                                ...
                                <div class="p-2">
                                    ...
                                    @if (auth()->user()->role=="admin")
                                    <form method="GET" action="/barang-tambah">
                                ...
                                <table id="tbl_exporttable_to_xls" class="table-responsive table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <div class="ms-5 me-5">
                                                <form method="GET" action="/barang-update/{{$value->id}}">
                                                    @csrf
                                                    <div class="mb-3">
                                                        <h4>Editing</h4>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="barang" name="nama" aria-describedby="barangItem" value="{{$value->nama}}">
                                        ...
                                        <hr>
                                        <br>
                                        @foreach ($perbarangs as $value)
                                        <tr>
                                            <td scope="row">{{$loop->iteration}}</td>
                                            <td>{{$value->nama}}</td>
                                            @if (auth()->user()->role=="admin")
                                            <td>
                                                <form method="GET" action="/barang-edit/{{$value->id}}">
                                                    @csrf
                                                    <button type="submit" class="btn btn-success text-light">Edit</button>
                                                </form>
                                            </td>
                                            <td>
                                                <form method="GET" action="/barang-hapus/{{$value->id}}">
                                                    @csrf
