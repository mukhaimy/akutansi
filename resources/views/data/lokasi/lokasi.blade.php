                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="d-flex justify-content-between align-self-center">
                                ...
                                <div class="p-2">
                                    <form method="POST" action="/lokasi-import" enctype="multipart/form-data">
                                        @csrf
                                ...
                                <div class="p-2">
                                    ...
                                    @if (auth()->user()->role=="admin")
                                    <form method="GET" action="/lokasi-tambah">
                                ...
                                <table id="tbl_exporttable_to_xls" class="table-responsive table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <div class="ms-5 me-5">
                                                <form method="GET" action="/lokasi-update/{{$value->id}}">
                                                    @csrf
                                                    <div class="mb-3">
                                                        <h4>Editing</h4>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="lokasi" name="lokasi" aria-describedby="lokasi" value="{{$value->nama}}" required>
                                        ...
                                        <tr>
                                            ...
                                            @if (auth()->user()->role=="admin")
                                            <td>
                                                <form method="GET" action="/lokasi-edit/{{$value->id}}">
                                                    @csrf
                                                    <button type="submit" class="btn btn-success text-light">Edit</button>
                                                </form>
                                            </td>
                                            <td>
                                                <form method="GET" action="/lokasi-hapus/{{$value->id}}">
                                                    @csrf
...
<script>
    function ExportToExcel(type, fn, dl) {
        ...
        return dl ?
            ...
            XLSX.writeFile(wb, fn || ('lokasi.' + (type || 'xlsx')));
    }
</script>
